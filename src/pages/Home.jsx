    ...
    <div>
        ...
        <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between'>
            <Link to={"/signup"}>
                ...
                transition-all duration-200 hover:scale-95 w-fit '>
                    <div className='flex flex-row items-center gap-2 px-10 py-[5px] rounded-full group-hover:bg-richblack-900 transition-all duration-200'>
        ...
        <div className='bg-pure-greys-5 text-richblack-700'>
            ...
            <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-8 '>
                    <div className='flex flex-col gap-7 mb-10 mt-[-100px] justify-between lg:mt-20 lg:flex-row lg:gap-0'>
